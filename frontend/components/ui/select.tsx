  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg]:text-white/40",
        className,
      )}
      {...props}
    >
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-white/[0.08] pointer-events-none -mx-1 my-1 h-px", className)}
      {...props}
    />
  );
}
