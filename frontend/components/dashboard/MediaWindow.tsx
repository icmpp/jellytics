...
import { PlayCircle, Play, FolderPlus, Sparkles } from "lucide-react";
import { cn } from "@/lib/utils";
import { ContinueWatchingContent } from "./ContinueWatching";
import { RecentlyAddedContent } from "./RecentlyAdded";
...
export function MediaWindow() {
  const [active, setActive] = useState<TabId>("continue");
