...
import { Calendar, Clock, Flame, Loader2, TrendingDown, TrendingUp, Zap } from "lucide-react";
...
export function WatchTimeChartContent() {
    ...
    <>
      ...
      <div className="min-h-[230px] flex-1">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart
            data={chartData}
            margin={{ top: 8, right: 16, left: 0, bottom: days > 30 ? 28 : 8 }}
          >
            <defs>
