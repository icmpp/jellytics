  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Outer rim ── */}
        <rect x="0.5" y="0.5" width="39" height="39" rx="9.5" stroke="white" strokeOpacity="0.16" />
        ...
        <path d="M 10.75,23 L 20,10 L 29.25,16 L 29.25,31 L 10.75,31 Z" fill={`url(#${areaId})`} />
