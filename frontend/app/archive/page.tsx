...
export default function ArchivePage() {
  ...
  const icon = <Archive className="h-6 w-6 sm:h-7 sm:w-7 text-purple-400 shrink-0" />;
    ...
    <SimpleMediaGridPage<ArchiveItem>
      ...
      errorContent={
        <div className="flex flex-col items-center py-24 text-center">
          ...
          <p className="text-base font-medium text-white/60 mb-1.5">Failed to load archive</p>
