...
type ToastFn = typeof baseToast & {
  success: (props: Omit<Toast, "variant">) => ReturnType<typeof baseToast>;
  error: (props: Omit<Toast, "variant">) => ReturnType<typeof baseToast>;
  info: (props: Omit<Toast, "variant">) => ReturnType<typeof baseToast>;
  warning: (props: Omit<Toast, "variant">) => ReturnType<typeof baseToast>;
};
